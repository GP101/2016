...
const KQuaternion KQuaternion::iHat = KQuaternion( 0.0, 1.0, 0.0, 0.0 );
const KQuaternion KQuaternion::jHat = KQuaternion( 0.0, 0.0, 1.0, 0.0 );
const KQuaternion KQuaternion::kHat = KQuaternion( 0.0, 0.0, 0.0, 1.0 );


KQuaternion operator+(const double t, const KQuaternion& Q) { return KQuaternion(Q.w + t, Q.x, Q.y, Q.z); }
KQuaternion operator-(const double t, const KQuaternion& Q) { return KQuaternion(Q.w - t, Q.x, Q.y, Q.z); }
KQuaternion operator*(const double t, const KQuaternion& Q) { return KQuaternion(Q.w * t, Q.x * t, Q.y * t, Q.z * t); }
